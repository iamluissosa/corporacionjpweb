            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-900/30 border border-blue-500/30 text-blue-400 text-sm font-medium">
                        ...
                        Disponible ahora en Carabobo
                    </div>

                    <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-white leading-tight">
                        Soluciones Industriales <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">Integrales & Robustas</span>
                    </h1>

                    <p className="text-lg text-slate-400 max-w-xl leading-relaxed">
                        Desde ingeniería civil y automatización PLC hasta outsourcing especializado. Garantizamos la continuidad operativa de su planta con estándares internacionales.
                    </p>
                    ...
                    <div className="flex items-center gap-6 pt-4 text-sm text-slate-500 font-medium">
                        <span className="flex items-center gap-2"><CheckCircle2 className="text-green-500 w-4 h-4" /> Normativa ISO</span>
                        <span className="flex items-center gap-2"><CheckCircle2 className="text-green-500 w-4 h-4" /> Soporte 24/7</span>
                    </div>
                </motion.div>
                    ...
                    <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl shadow-blue-900/20 bg-slate-900/50 backdrop-blur-sm">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-white font-bold">Personal Certificado</p>
                            </div>
                        </motion.div>
                        ...
                        >
                            <p className="text-xs opacity-80 uppercase font-semibold">Eficiencia</p>
